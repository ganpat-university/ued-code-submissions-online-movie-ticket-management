c<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" isELIgnored="false"%>
...
<head>
	...
	<link rel="stylesheet" href="resources/css/seats.css" type="text/css">
						...
						<div class="col-sm-5 screen">
								...
								<section id="seats">
								  ...
								  <div class="col-sm-5">
								  	...
								  	<a href ="ticket.jsp">submit</a> </button>
									</div>
								  </div>
